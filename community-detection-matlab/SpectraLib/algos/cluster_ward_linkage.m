function [assignment_multicut,param_string]=cluster_ward_linkage(S,k)
...
% assignment_multicut( 1,n ) vector of integers 1:k assigning the points to clusters
  ...
  if nargout ==2
	[assignment_multicut,param_string]=cluster_linkage(S,k,'ward'); 
  else
	assignment_multicut=cluster_linkage(S,k,'ward'); 
  end
